...
export function Admin() {
  ...
  // Filter lists
  const pendingCases = farmers.filter(f => !f.verified);
  const verifiedCases = farmers.filter(f => f.verified);
                      ...
                      <div key={farmer.id} className="bg-card border border-border rounded-3xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                        <div>
                          <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="bg-destructive/10 border border-destructive/20 text-destructive text-[10px] font-bold px-2.5 py-1 rounded-md uppercase">
                        ...
                        <div key={farmer.id} className="bg-card border border-border rounded-3xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                          <div>
                            <div className="flex justify-between items-start mb-4">
                              ...
                              <span className="bg-[#1b5e20]/10 border border-[#1b5e20]/20 text-[#1b5e20] text-[10px] font-bold px-2.5 py-1 rounded-md uppercase flex items-center gap-1">
                          ...
                          <div className="flex items-center gap-3 border-t border-border pt-4 mt-auto">
                            ...
                            >
                              <Edit3 className="w-4 h-4" /> Edit Fundraiser Details
                            </button>
                            <button 
                              onClick={() => handleDelete(farmer.id)}
                              className="p-2.5 border border-destructive/20 hover:bg-destructive/10 text-destructive rounded-xl transition-colors"
